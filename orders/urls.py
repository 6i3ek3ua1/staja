...
from .views import OrderView, SuccessTemplateView, CancelTemplateView, OrderListView, OrderConsultView, order_remove, receipt_list_view
...
urlpatterns = [
    ...
    path('receipt/', receipt_list_view, name='receipt'),
]
